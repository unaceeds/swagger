...
public interface DefaultApi {
    ...
    ResponseEntity<Result> rootGet(@ApiParam(value = "") @Valid @RequestParam(value = "a", required = false) String a,@ApiParam(value = "") @Valid @RequestParam(value = "b", required = false) String b,@ApiParam(value = "") @Valid @RequestParam(value = "op", required = false) String op);
